  ...
  try {
    ...
    if (decryptedData.status === "00") {
      await createNotification({
        ...
        description: `Your ${decryptedData.price}BDT Withdrawal was successfully sent to your account`,
        userId: user!.id!,
        icon: "MONEY",
      });
    } else {
      await createNotification({
        ...
        description: `Your ${decryptedData.price}BDT Withdrawal was Failed`,
        userId: user!.id!,
        icon: "MONEY",
      });
    }
